...
blastn -task blastn-short -db genedb/isecp1blast -query ${assembly} -outfmt 6 >${label}.iseblast.tsv
                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                          ~/Code/prokka/bin/prokka --outdir /atium/Data/Nanopore/Analysis/161223_kpneumo/${label}_genus --genus Klebsiella --usegenus \                 --prefix 811A_genus /atium/Data/NGS/Aligned/161027_SSSSS/
